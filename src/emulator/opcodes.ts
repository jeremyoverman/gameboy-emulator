...
export class OpCodes {
  ...
  opcodes: Record<number, OpCodeDefinition> = {
    ...
    0x01: { name: 'LD BC,d16',   length: 3, cycles: 12,       run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'bc', source: 'd16' }) },
    0x02: { name: 'LD (BC),A',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'bc', refTarget: true, source: 'a' }) },
    ...
    0x06: { name: 'LD B,d8',     length: 2, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', source: 'd8' }) },
    0x07: { name: 'RLCA',        length: 1, cycles: 4,        run: () => this.cpu.instructions.rlca() },
    0x08: { name: 'LD (a16),SP', length: 3, cycles: 20,       run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd16', source: 'sp' }) },
    0x09: { name: 'ADD HL,BC',   length: 1, cycles: 8,        run: () => this.cpu.instructions.add('bc') },
    0x0a: { name: 'LD A,(BC)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', refSource: true, source: 'bc' }) },
    ...
    0x0e: { name: 'LD C,d8',     length: 2, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', source: 'd8' }) },
    0x0f: { name: 'RRCA',        length: 1, cycles: 4,        run: () => this.cpu.instructions.rrca() },
    0x10: { name: 'STOP',        length: 1, cycles: 4,        run: () => this.cpu.instructions.stop() },
    0x11: { name: 'LD DE,d16',   length: 3, cycles: 12,       run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'de', source: 'd16' }) },
    0x12: { name: 'LD (DE),A',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'de', source: 'a'}) },
    ...
    0x16: { name: 'LD D,d8',     length: 2, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', source: 'd8' }) },
    ...
    0x1a: { name: 'LD A,(DE)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', refSource: true, source: 'de' }) },
    ...
    0x1e: { name: 'LD E,d8',     length: 2, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', source: 'd8' }) },
    ...
    0x21: { name: 'LD HL,d16',   length: 3, cycles: 12,       run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'hl', source: 'd16' }) },
    0x22: { name: 'LD (HL+),A',  length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'a', incHl: true }) },
    ...
    0x26: { name: 'LD H,d8',     length: 2, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', source: 'd8' }) },
    ...
    0x2a: { name: 'LD A,(HL+)',  length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', refSource: true, source: 'hl', incHl: true }) },
    ...
    0x2e: { name: 'LD L,d8',     length: 2, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', source: 'd8' }) },
    ...
    0x31: { name: 'LD SP,d16',   length: 3, cycles: 12,       run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'sp', source: 'd16' }) },
    0x32: { name: 'LD (HL-),A',  length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { source: 'a', refTarget: true, target: 'hl', decHl: true }) },
    0x33: { name: 'INC SP',      length: 1, cycles: 8,        run: () => this.cpu.instructions.inc('sp') },
    0x34: { name: 'INC (HL)',    length: 1, cycles: 12,       run: () => this.cpu.instructions.inc('hl', true) },
    0x35: { name: 'DEC (HL)',    length: 1, cycles: 12,       run: () => this.cpu.instructions.dec('hl', true) },
    0x36: { name: 'LD (HL),d8',  length: 2, cycles: 12,       run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'd8' }) },
    0x37: { name: 'SCF',         length: 1, cycles: 4,        run: () => this.cpu.instructions.scf() },
    0x38: { name: 'JR C,r8',     length: 2, cycles: [12, 8],  run: (_pc, byte) => this.cpu.instructions.jp(byte, JumpMode.c, true) },
    0x39: { name: 'ADD HL,SP',   length: 1, cycles: 8,        run: () => this.cpu.instructions.add('sp') },
    0x3a: { name: 'LD A,(HL-)',  length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', refSource: true, source: 'hl', decHl: true }) },
    ...
    0x3e: { name: 'LD A,d8',     length: 2, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', source: 'd8' }) },
    0x3f: { name: 'CCF',         length: 1, cycles: 4,        run: () => this.cpu.instructions.ccf() },
    0x40: { name: 'LD B,B',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', source: 'b' }) },
    0x41: { name: 'LD B,C',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', source: 'c' }) },
    0x42: { name: 'LD B,D',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', source: 'd' }) },
    0x43: { name: 'LD B,E',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', source: 'e' }) },
    0x44: { name: 'LD B,H',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', source: 'h' }) },
    0x45: { name: 'LD B,L',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', source: 'l' }) },
    0x46: { name: 'LD B,(HL)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', refSource: true, source: 'hl' }) },
    0x47: { name: 'LD B,A',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'b', source: 'a' }) },
    0x48: { name: 'LD C,B',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', source: 'b' }) },
    0x49: { name: 'LD C,C',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', source: 'c' }) },
    0x4a: { name: 'LD C,D',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', source: 'd' }) },
    0x4b: { name: 'LD C,E',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', source: 'e' }) },
    0x4c: { name: 'LD C,H',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', source: 'h' }) },
    0x4d: { name: 'LD C,L',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', source: 'l' }) },
    0x4e: { name: 'LD C,(HL)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', refSource: true, source: 'hl' }) },
    0x4f: { name: 'LD C,A',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'c', source: 'a' }) },
    0x50: { name: 'LD D,B',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', source: 'b' }) },
    0x51: { name: 'LD D,C',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', source: 'c' }) },
    0x52: { name: 'LD D,D',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', source: 'd' }) },
    0x53: { name: 'LD D,E',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', source: 'e' }) },
    0x54: { name: 'LD D,H',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', source: 'h' }) },
    0x55: { name: 'LD D,L',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', source: 'l' }) },
    0x56: { name: 'LD D,(HL)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', refSource: true, source: 'hl' }) },
    0x57: { name: 'LD D,A',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd', source: 'a' }) },
    0x58: { name: 'LD E,B',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', source: 'b' }) },
    0x59: { name: 'LD E,C',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', source: 'c' }) },
    0x5a: { name: 'LD E,D',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', source: 'd' }) },
    0x5b: { name: 'LD E,E',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', source: 'e' }) },
    0x5c: { name: 'LD E,H',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', source: 'h' }) },
    0x5d: { name: 'LD E,L',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', source: 'l' }) },
    0x5e: { name: 'LD E,(HL)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', refSource: true, source: 'hl' }) },
    0x5f: { name: 'LD E,A',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'e', source: 'a' }) },
    0x60: { name: 'LD H,B',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', source: 'b' }) },
    0x61: { name: 'LD H,C',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', source: 'c' }) },
    0x62: { name: 'LD H,D',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', source: 'd' }) },
    0x63: { name: 'LD H,E',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', source: 'e' }) },
    0x64: { name: 'LD H,H',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', source: 'h' }) },
    0x65: { name: 'LD H,L',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', source: 'l' }) },
    0x66: { name: 'LD H,(HL)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', refSource: true, source: 'hl' }) },
    0x67: { name: 'LD H,A',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'h', source: 'a' }) },
    0x68: { name: 'LD L,B',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', source: 'b' }) },
    0x69: { name: 'LD L,C',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', source: 'c' }) },
    0x6a: { name: 'LD L,D',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', source: 'd' }) },
    0x6b: { name: 'LD L,E',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', source: 'e' }) },
    0x6c: { name: 'LD L,H',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', source: 'h' }) },
    0x6d: { name: 'LD L,L',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', source: 'l' }) },
    0x6e: { name: 'LD L,(HL)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', refSource: true, source: 'hl' }) },
    0x6f: { name: 'LD L,A',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'l', source: 'a' }) },
    0x70: { name: 'LD (HL),B',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'b' }) },
    0x71: { name: 'LD (HL),C',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'c' }) },
    0x72: { name: 'LD (HL),D',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'd' }) },
    0x73: { name: 'LD (HL),E',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'e' }) },
    0x74: { name: 'LD (HL),H',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'h' }) },
    0x75: { name: 'LD (HL),L',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'l' }) },
    0x76: { name: 'HALT',        length: 1, cycles: 4,        run: () => this.cpu.instructions.halt() },
    0x77: { name: 'LD (HL),A',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { refTarget: true, target: 'hl', source: 'a' }) },
    0x78: { name: 'LD A,B',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', source: 'b' }) },
    0x79: { name: 'LD A,C',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', source: 'c' }) },
    0x7a: { name: 'LD A,D',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', source: 'd' }) },
    0x7b: { name: 'LD A,E',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', source: 'e' }) },
    0x7c: { name: 'LD A,H',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', source: 'h' }) },
    0x7d: { name: 'LD A,L',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', source: 'l' }) },
    0x7e: { name: 'LD A,(HL)',   length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', refSource: true, source: 'hl' }) },
    0x7f: { name: 'LD A,A',      length: 1, cycles: 4,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', source: 'a' }) },
    ...
    0x86: { name: 'ADD A,(HL)',  length: 1, cycles: 8,        run: () => this.cpu.instructions.add('hl', false, true) },
    ...
    0x8e: { name: 'ADC A,(HL)',  length: 1, cycles: 8,        run: () => this.cpu.instructions.adc('hl', true) },
    ...
    0x96: { name: 'SUB (HL)',    length: 1, cycles: 8,        run: () => this.cpu.instructions.sub('hl', false, true) },
    ...
    0x9e: { name: 'SBC A,(HL)',  length: 1, cycles: 8,        run: () => this.cpu.instructions.sbc('hl', true) },
    ...
    0xa6: { name: 'AND (HL)',    length: 1, cycles: 8,        run: () => this.cpu.instructions.and('hl', true) },
    ...
    0xae: { name: 'XOR (HL)',    length: 1, cycles: 8,        run: () => this.cpu.instructions.xor('hl', true) },
    ...
    0xb6: { name: 'OR (HL)',     length: 1, cycles: 8,        run: () => this.cpu.instructions.or('hl', true) },
    ...
    0xbe: { name: 'CP (HL)',     length: 1, cycles: 8,        run: () => this.cpu.instructions.cp('hl', true) },
    0xbf: { name: 'CP A',        length: 1, cycles: 4,        run: () => this.cpu.instructions.cp('a') },
    0xc0: { name: 'RET NZ',      length: 1, cycles: [20, 8],  run: () => this.cpu.instructions.ret(JumpMode.nz) },
    ...
    0xc7: { name: 'RST 00H',     length: 1, cycles: 16,       run: () => this.cpu.instructions.rst(0x00) },
    0xc8: { name: 'RET Z',       length: 1, cycles: [20, 8],  run: () => this.cpu.instructions.ret(JumpMode.z) },
    0xc9: { name: 'RET',         length: 1, cycles: 16,       run: () => this.cpu.instructions.ret() },
    0xca: { name: 'JP Z,a16',    length: 3, cycles: [16, 12], run: (_pc, bytes) => this.cpu.instructions.jp(bytes, JumpMode.z) },
    0xcb: { name: 'PREFIX CB',   length: 1, cycles: 4,        run: () => this.cpu.instructions.nop() },
    ...
    0xcf: { name: 'RST 08H',     length: 1, cycles: 16,       run: () => this.cpu.instructions.rst(0x08) },
    0xd0: { name: 'RET NC',      length: 1, cycles: [20, 8],  run: () => this.cpu.instructions.ret(JumpMode.nc) },
    ...
    0xd7: { name: 'RST 10H',     length: 1, cycles: 16,       run: () => this.cpu.instructions.rst(0x10) },
    0xd8: { name: 'RET C',       length: 1, cycles: [20, 8],  run: () => this.cpu.instructions.ret(JumpMode.c) },
    0xd9: { name: 'RETI',        length: 1, cycles: 16,       run: () => this.cpu.instructions.reti() },
    ...
    0xdf: { name: 'RST 18H',     length: 1, cycles: 16,       run: () => this.cpu.instructions.rst(0x18) },
    0xe0: { name: 'LDH (a8),A',  length: 2, cycles: 12,       run: (_pc, bytes) => this.cpu.instructions.ldh(bytes, false) },
    0xe1: { name: 'POP HL',      length: 1, cycles: 12,       run: () => this.cpu.instructions.pop('hl') },
    0xe2: { name: 'LD (C),A',    length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { source: 'a', refTarget: true, target: 'c' }) },
    0xe3: null,
    0xe4: null,
    ...
    0xe7: { name: 'RST 20H',     length: 1, cycles: 16,       run: () => this.cpu.instructions.rst(0x20) },
    0xe8: { name: 'ADD SP,r8',   length: 2, cycles: 16,       run: (_pc, [value]) => this.cpu.instructions.add_sp('sp', value) },
    0xe9: { name: 'JP (HL)',     length: 1, cycles: 4,        run: () => this.cpu.instructions.jp() },
    0xea: { name: 'LD (a16),A',  length: 3, cycles: 16,       run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'd16', source: 'a' }) },
    0xeb: null,
    0xec: null,
    0xed: null,
    0xee: { name: 'XOR d8',      length: 2, cycles: 8,        run: (_pc, [value]) => this.cpu.instructions.xor(value) },
    0xef: { name: 'RST 28H',     length: 1, cycles: 16,       run: () => this.cpu.instructions.rst(0x28) },
    0xf0: { name: 'LDH A,(a8)',  length: 2, cycles: 12,       run: (_pc, bytes) => this.cpu.instructions.ldh(bytes, true) },
    0xf1: { name: 'POP AF',      length: 1, cycles: 12,       run: () => this.cpu.instructions.pop('af') },
    0xf2: { name: 'LD A,(C)',    length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', refSource: true, source: 'c' }) },
    0xf3: { name: 'DI',          length: 1, cycles: 4,        run: () => this.cpu.instructions.di() },
    0xf4: null,
    ...
    0xf7: { name: 'RST 30H',     length: 1, cycles: 16,       run: () => this.cpu.instructions.rst(0x30) },
    0xf8: { name: 'LD HL,SP+r8', length: 2, cycles: 12,       run: (_pc, [value]) => this.cpu.instructions.add_sp('hl', value) },
    0xf9: { name: 'LD SP,HL',    length: 1, cycles: 8,        run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'sp', source: 'hl' }) },
    0xfa: { name: 'LD A,(a16)',  length: 3, cycles: 16,       run: (_pc, bytes) => this.cpu.instructions.ld(bytes, { target: 'a', refSource: true, source: 'd16' }) },
    0xfb: { name: 'EI',          length: 1, cycles: 4,        run: () => this.cpu.instructions.ei() },
    0xfc: null,
    0xfd: null,
    0xfe: { name: 'CP d8',       length: 2, cycles: 8,        run: (_pc, [value]) => this.cpu.instructions.cp(value) },
    0xff: { name: 'RST 38H',     length: 1, cycles: 16,       run: () => this.cpu.instructions.rst(0x38) },
  }
  ...
  prefixOpcodes: Record<number, OpCodeDefinition> = {
    ...
    0x06: { name: 'RLC (HL)',    length: 2, cycles: 16,       run: () => this.cpu.instructions.rlc('hl', true)},
    ...
    0x0e: { name: 'RRC (HL)',    length: 2, cycles: 16,       run: () => this.cpu.instructions.rrc('hl', true)},
    ...
    0x16: { name: 'RL (HL)',     length: 2, cycles: 16,       run: () => this.cpu.instructions.rl('hl', true)},
    ...
    0x1e: { name: 'RR (HL)',     length: 2, cycles: 16,       run: () => this.cpu.instructions.rr('hl', true)},
    ...
    0x26: { name: 'SLA (HL)',    length: 2, cycles: 16,       run: () => this.cpu.instructions.sla('hl', true)},
    ...
    0x2e: { name: 'SRA (HL)',    length: 2, cycles: 16,       run: () => this.cpu.instructions.sra('hl', true)},
    ...
    0x36: { name: 'SWAP (HL)',   length: 2, cycles: 16,       run: () => this.cpu.instructions.swap('hl', true)},
    ...
    0x3e: { name: 'SRL (HL)',    length: 2, cycles: 16,       run: () => this.cpu.instructions.srl('hl', true)},
    ...
    0x46: { name: 'BIT 0,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.bit('hl', 0)},
    ...
    0x4e: { name: 'BIT 1,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.bit('hl', 1)},
    ...
    0x56: { name: 'BIT 2,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.bit('hl', 2)},
    ...
    0x5e: { name: 'BIT 3,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.bit('hl', 3)},
    ...
    0x66: { name: 'BIT 4,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.bit('hl', 4)},
    ...
    0x6e: { name: 'BIT 5,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.bit('hl', 5)},
    ...
    0x76: { name: 'BIT 6,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.bit('hl', 6)},
    ...
    0x7e: { name: 'BIT 7,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.bit('hl', 7)},
    ...
    0x86: { name: 'RES 0,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.reset('hl', 0)},
    ...
    0x8e: { name: 'RES 1,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.reset('hl', 1)},
    ...
    0x96: { name: 'RES 2,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.reset('hl', 2)},
    ...
    0x9e: { name: 'RES 3,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.reset('hl', 3)},
    ...
    0xa6: { name: 'RES 4,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.reset('hl', 4)},
    ...
    0xae: { name: 'RES 5,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.reset('hl', 5)},
    ...
    0xb6: { name: 'RES 6,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.reset('hl', 6)},
    ...
    0xbe: { name: 'RES 7,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.reset('hl', 7)},
    ...
    0xc6: { name: 'SET 0,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.set('hl', 0)},
    ...
    0xce: { name: 'SET 1,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.set('hl', 1)},
    ...
    0xd6: { name: 'SET 2,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.set('hl', 2)},
    ...
    0xde: { name: 'SET 3,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.set('hl', 3)},
    ...
    0xe6: { name: 'SET 4,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.set('hl', 4)},
    ...
    0xee: { name: 'SET 5,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.set('hl', 5)},
    ...
    0xf6: { name: 'SET 6,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.set('hl', 6)},
    ...
    0xfe: { name: 'SET 7,(HL)',  length: 2, cycles: 16,       run: () => this.cpu.instructions.set('hl', 7)},
