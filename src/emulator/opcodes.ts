...
export class OpCodes {
  ...
  private jump(args?: Uint8Array, mode?: JumpMode | null, relative?: boolean) {
    ...
    const jumped = this.cpu.instructions.jp(address, mode, relative)
  ...
  opcodes: Record<number, OpCodeDefinition> = {
    ...
    0xc1: { name: 'POP BC',      length: 1, cycles: 12,       run: () => this.notImplemented() },
    0xc2: { name: 'JP NZ,a16',   length: 3, cycles: [16, 12], run: (_pc, bytes) => this.jump(bytes, JumpMode.nz) },
    0xc3: { name: 'JP a16',      length: 3, cycles: 16,       run: (_pc, bytes) => this.jump(bytes) },
    0xc4: { name: 'CALL NZ,a16', length: 3, cycles: [24, 12], run: () => this.notImplemented() },
    0xc5: { name: 'PUSH BC',     length: 1, cycles: 16,       run: () => this.notImplemented() },
    0xc6: { name: 'ADD A,d8',    length: 2, cycles: 8,        run: (_pc, [value]) => this.cpu.instructions.add(value) },
    0xc7: { name: 'RST 00H',     length: 1, cycles: 16,       run: () => this.notImplemented() },
    0xc8: { name: 'RET Z',       length: 1, cycles: [20, 8],  run: () => this.notImplemented() },
    0xc9: { name: 'RET',         length: 1, cycles: 16,       run: () => this.notImplemented() },
    0xca: { name: 'JP Z,a16',    length: 3, cycles: [16, 12], run: (_pc, bytes) => this.jump(bytes, JumpMode.z) },
    0xcb: { name: 'PREFIX CB',   length: 1, cycles: 4,        run: () => this.notImplemented() },
    0xcc: { name: 'CALL Z,a16',  length: 3, cycles: [24, 12], run: () => this.notImplemented() },
    0xcd: { name: 'CALL a16',    length: 3, cycles: 24,       run: () => this.notImplemented() },
    0xce: { name: 'ADC A,d8',    length: 2, cycles: 8,        run: (_pc, [value]) => this.cpu.instructions.adc(value) },
    0xcf: { name: 'RST 08H',     length: 1, cycles: 16,       run: () => this.notImplemented() },
    0xd0: { name: 'RET NC',      length: 1, cycles: [20, 8],  run: () => this.notImplemented() },
    0xd1: { name: 'POP DE',      length: 1, cycles: 12,       run: () => this.notImplemented() },
    0xd2: { name: 'JP NC,a16',   length: 3, cycles: [16, 12], run: (_pc, bytes) => this.jump(bytes, JumpMode.nc) },
    0xd3: null,
    0xd4: { name: 'CALL NC,a16', length: 3, cycles: [24, 12], run: () => this.notImplemented() },
    0xd5: { name: 'PUSH DE',     length: 1, cycles: 16,       run: () => this.notImplemented() },
    0xd6: { name: 'SUB d8',      length: 2, cycles: 8,        run: (_pc, [value]) => this.cpu.instructions.sub(value) },
    0xd7: { name: 'RST 10H',     length: 1, cycles: 16,       run: () => this.notImplemented() },
    0xd8: { name: 'RET C',       length: 1, cycles: [20, 8],  run: () => this.notImplemented() },
    0xd9: { name: 'RETI',        length: 1, cycles: 16,       run: () => this.notImplemented() },
    0xda: { name: 'JP C,a16',    length: 3, cycles: [16, 12], run: (_pc, bytes) => this.jump(bytes, JumpMode.c) },
    0xdb: null,
    0xdc: { name: 'CALL C,a16',  length: 3, cycles: [24, 12], run: () => this.notImplemented() },
    0xdd: null,
    0xde: { name: 'SBC A,d8',    length: 2, cycles: 8,        run: (_pc, [value]) => this.cpu.instructions.sbc(value) },
    0xdf: { name: 'RST 18H',     length: 1, cycles: 16,       run: () => this.notImplemented() },
    0xe0: { name: 'LDH (a8),A',  length: 2, cycles: 12,       run: () => this.notImplemented() },
    0xe1: { name: 'POP HL',      length: 1, cycles: 12,       run: () => this.notImplemented() },
    0xe2: { name: 'LD (C),A',    length: 2, cycles: 8,        run: () => this.notImplemented() },
    0xe3: null,
    0xe4: null,
    0xe5: { name: 'PUSH HL',     length: 1, cycles: 16,       run: () => this.notImplemented() },
    ...
    0xf1: { name: 'POP AF',      length: 1, cycles: 12,       run: () => this.notImplemented() },
    0xf2: { name: 'LD A,(C)',    length: 2, cycles: 8,        run: () => this.notImplemented() },
    0xf3: { name: 'DI',          length: 1, cycles: 4,        run: () => this.notImplemented() },
    0xf4: null,
    0xf5: { name: 'PUSH AF',     length: 1, cycles: 16,       run: () => this.notImplemented() },
